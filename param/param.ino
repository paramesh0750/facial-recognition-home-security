...
const char* ssid = "Galaxy F2212E8";  //WiFi Name
const char* password = "nyjs6202";  //WiFi Password

// Use @myidbot to find out the chat ID of an individual or a group
// You need to click "start" on a bot before it can message you 
// Initialize Telegram BOT
String chatId = "7458522647";
String BOTtoken = "7783928928:AAF1CXkTsBK97xDSqdv9zWhIz8Ee0bbhghE";
