...
const char* ssid = "Galaxy M14 5G E522";  //WiFi Name
const char* password = "keeru@123";  //WiFi Password

// Use @myidbot to find out the chat ID of an individual or a group
// You need to click "start" on a bot before it can message you 
// Initialize Telegram BOT
String chatId = "7783928928";
String BOTtoken = "7838170611:AAHL-F6Oc8ZNWGQA6Fb_IZ1N0nScafKEUo4";
